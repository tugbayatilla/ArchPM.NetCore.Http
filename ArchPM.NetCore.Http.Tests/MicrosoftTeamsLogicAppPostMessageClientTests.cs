...
namespace ArchPM.NetCore.Http.Tests
{
    ...
    {
        private DefaultMicrosoftTeamsLogicAppPostMessageClient CreateClient(IMicrosoftTeamsLogicAppPostMessageClientSettings settings = null, HttpClient httpClient = null)
        {
            if (settings == null)
            {
